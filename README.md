...
- [CPLUG](https://github.com/Tremus/CPLUG) - A smart new plug-in abstraction in C that targets VST3, AUv2, CLAP and Standalone formats on desktop. It's very new but a nice clean and minimal way to target multiple formats producing tiny binaries. Also includes hot reloading capabilities for the standalone targets.
...
- [ELK Audio OS]([https://elk.audio/dev-kit/](https://os.elk.audio/)) - An embedded linux OS & dev kit that runs VST2 & VST3 plugins with super low latency.
...
- [ToteBagLabs - Lofi Audio Effects Prototyping to chill/relax to](https://www.youtube.com/@ToteBagLabs) - My friend and Ableton colleague Jose is recording his work developing plug-ins in Juce/C++ and DSP code using CMajor.
